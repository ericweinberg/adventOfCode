...
public class Day8 {
    ...
    public static void main(String[] args) {
        ...
        Day8Result result = day8.countCharacters(Arrays.asList(inputString.split("\r\n")));
        logger.info("The number of codeCharacters is {} and the number of characters in memory is {}, the difference is {}",
                result.getNumberOfCodeCharacters(), result.getNumberOfMemoryCharacters(),
                result.getNumberOfCodeCharacters()-result.getNumberOfMemoryCharacters());
    }

    public Day8Result countCharacters(List<String> strings) {
